...
- [ ] This week you'll be working on Exploratory Data Analysis in
...
- [ ] *There will be a written test in class next Monday (on EDA I)*!

- [ ] *There is no class meeting on Wed: Work on your term projects!*

** Term projects

Remember:
1) Satisfy all assignment requirements.
2) Look at some examples for abstracts (linked).
3) Make sure you have references.
4) Make sure your references are complete and consistent.
5) Make sure that you're reporting on your results (+/-).
