...
* Week 6: R options and packages (Sep 29, Oct 1, Oct 3)

- [ ] Don't forget test 5 (deadline Sunday). Test 6 live today.

- [ ] Don't forget home assignment 2 (deadline Monday).

- [ ] Don't forget the 2nd DataCamp lesson on R (vectors) by Sunday.

- [ ] Don't forget the 2nd sprint review deadline (by next Friday).

** DONE Review: Weekly Snack Budget Assignment
