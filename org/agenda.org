...
4. What's an API (in the context of data science)?
   ...
   : Error in GET(url) : could not find function "GET"
   : Error in content(response, "text") : could not find function "content"
   : Error in fromJSON(content) : object 'content' not found
   : Error in data$setup : object of type 'closure' is not subsettable
   : Error in data$punchline : object of type 'closure' is not subsettable
...
6. What is the main goal of EDA?
   ...
   #+RESULTS:
   :      Name                Age             Size         Country         
   :  Length:3           Min.   :27.00   Min.   :1.700   Length:3          
   :  Class :character   1st Qu.:27.50   1st Qu.:1.735   Class :character  
   :  Mode  :character   Median :28.00   Median :1.770   Mode  :character  
   :                     Mean   :28.33   Mean   :1.757                     
   :                     3rd Qu.:29.00   3rd Qu.:1.785                     
   :                     Max.   :30.00   Max.   :1.800
...
9. Which picture or photo do you know that's "worth a thousand words"?
...
10. What are dashboards in data science, and what are they good for? 
    #+begin_quote
...
11. What are dashboards definitely not good for?
    #+begin_quote
    - Data preparation, cleaning and transformation
    - Explorative Data Analysis (because they are fixed)
    #+end_quote

12. What is "labeling" in data visualizations, and why is it important?
    #+begin_quote
...
* Week 4: Expo & More R (Sep 15, 17, 19)
#+attr_html: :width 200px :float nil:
[[../img/expo.png]]

- [ ] Career expo - why you should go
- [ ] 1st Sprint Review (project proposals) graded with feedback
- [ ] 2nd Sprint Review deliverable is a literature review (Oct 10)
- [ ] This week: Continue the DataCamp lesson review
- [ ] Last lesson of the "Understanding data science" course (due Fri)
...
1. *Fixture congestion* (Diego, Matheus, Frederico)
   #+begin_quote
   What is AUC/ROC?
   #+end_quote
   #+begin_quote
...
6. *Fentanyl in mice* (Levi)
   ...
   - *Type I error* (false positive): You conclude that there is an
     ...
     (positive) that isn't there (falsely). You conclude that DOI
     (some amphetamine?) does mitigate withdrawal symptoms in mice
     when it does actually not do that.
   - *Type II error*
   #+end_quote
