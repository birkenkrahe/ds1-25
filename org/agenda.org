...
* Week 13: DataCamp: EDA - Numerical data
#+attr_html: :width 400px :float nil:
...
- For the interpretation ("what does this mean?"), either make a
  ...
  Question: Create a summary of the =supp= variable of the =ToothGrowth=
  ...
  #+begin_quote
  The output shows how many guinea pigs received a supply (=supp=) of
  Orange Juice (=OJ=) and how many received a supply of Vitamin C (=VC=).
  #+end_quote
