...
* Week 5: More and more R (Sep 22, 24, 26)
...
** TODO On finding a literature review ([[https://chat.google.com/room/AAAALkEATEU/_zJhcqiKsiM/md-ig0qyGaM?cls=10][Google Chat post]])
...
- Don't discard the "Audio Overview" in NotebookLM - you can customize
  it by type and with a specific prompt.
  #+attr_html: :width 600px :float nil:
  [[../img/audio_overview.png]]

- You can now see another summary of my own research as a video
  overview (4 min), an audio overview (1:35 min), and papers at:
  [[https://tinyurl.com/research-mixer-2025][tinyurl.com/research-mixer-2025]] (default: 'long deep dive").
...
1. Why would you use with R on the command-line?
   #+begin_quote
   ...
   and headless (no GUI) use and integration of Unix tools
   (pipeline, text processing, pattern matching, etc.).
   #+end_quote
...
** NEXT Review (Environment, display options, packages)
