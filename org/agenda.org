g#+TITLE: AGENDA - INTRODUCTION TO DATA SCIENCE
...
* Week 13: DataCamp: EDA Test / EDA for numerical data
#+attr_html: :width 400px :float nil:
#+caption: Turkey dinner: Thanksgiving in the US
[[../img/turkey.jpg]]

- [ ] DataCamp review: EDA test - categorical data
- [ ] Annotating and building stacked/dodged barplots
- [ ] Numerical plots: Histograms, boxplots, scatterplots
- [ ] Introduction to the fourth (last) sprint review

** TODO EDA test (self-graded)
...
** TODO Plotting review questions
