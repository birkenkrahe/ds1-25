...
3. What should you remember about references in your project?
   #+begin_quote
   - They need to be consistently cited (pick a style, e.g. AMA), and
     they need to be complete (as defined by the style you picked.
...
4. What should you remember about data in your project?
   #+begin_quote
   - Always find out where the data originally came from.
   - Always validate the quality of the data.
   #+end_quote

5. What should you remember about methods in your project?
   #+begin_quote
   - If you use a method, study it first. Make sure it is appropriate.
   - Find other use cases that used the same or a similar method.
   - Make sure you understand the method (how) and the metric (what is
     measured and how).
   #+end_quote

6. Do you need to update your proposal according to my feedback?
   #+begin_quote
   Yes, you should, but you don't need to re-submit it. Keep building
   your project documentation. Remember to document as much as
   possible - both your results and your way of working.
   #+end_quote
