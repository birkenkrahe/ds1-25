...
* Week 4: Expo & more R & webinar & 2nd sprint review (Sep 15, 17, 19)
...
- [ ] Webinar on Git and GitHub this Friday 12 pm
- [ ] This week: Continue the DataCamp lesson review
- [ ] Last lesson of the "Understanding data science" course (due Fri)
- [ ] 2nd sprint review instructions and example
- [ ] Review Wednesday: R demo
- [ ] Test 4: Will include test questions based on the DataCamp lesson
- [ ] Next week: Start Introduction to R lesson on DataCamp
- [ ] Use a datalab notebook to try things out
...
** DONE Projects - update and next steps
#+attr_html: :width 400px:
[[../img/literature.jpeg]]
...
** DONE Review questions on your projects
#+attr_html: :width 400px:
[[../img/titanic.jpg]]
...
** DONE Webinar: Friday 12 pm - Introduction to Git and GitHub (see Google Chat)
...
** DONE Review: First Sprint Review Post Mortem
...
** NEXT Second Sprint Review with NotebookLM
...
** TODO Review (Wednesday)

1. What does the function =str(df)= show when applied to a data frame =df=
   in R?
   #+begin_quote
   It shows the structure: number of rows, columns, and each
   variable’s name, type and first few preview values.
   #+end_quote
...
5. In the code =df[-4, ]=, where =df= is a data frame, what does the =-4=
   do?
   #+begin_quote
...
** IN PROGRESS Finish "Preparation, Exploration, Visualization" Demo in R
...
** WAITING Introduction to R

- [ ] Why we are using R
- [ ] The R console
- [ ] R display options
- [ ] R packages
- [ ] Light data exploration with R
