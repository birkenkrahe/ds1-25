...
* Week 12: DataCamp: EDA - Categorical data 
...
- [ ] Give a short account of your term project progress now!

- [ ] Written test in class next Monday (on EDA 1st lesson).

- [ ] Home assignment based on this week:
